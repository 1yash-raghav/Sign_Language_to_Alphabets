...
def func(frame):
    ...
    thresh = cv2.threshold(hand, 210, 255, cv2.THRESH_BINARY_INV + cv2.MAT_DEPTH_MASK)[1]
    th = cv2.threshold(thresh, 210, 255, cv2.THRESH_BINARY_INV)[1] # marking a threshold for colours
    thresh = th
